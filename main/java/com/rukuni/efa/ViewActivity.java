...
public class ViewActivity extends Activity {
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ViewActivity.this, error.getMessage(), Toast.LENGTH_LONG).show();
                    }
                });
    ...
    private void showJSON(String response) {
        ...
        try
        {
            ...
            JSONArray result = jsonObject.getJSONArray(Config5.JSON_ARRAY2);

            if(result.length() < 1)
            {
                Toast.makeText(this, "Your Meter Number Has Not Reported!!", Toast.LENGTH_LONG).show();
                logoutUser();
                registerActivity();
                return;
            }
        ...
        ListAdapter adapter = new SimpleAdapter(ViewActivity.this, list, R.layout.activity_mylist2, new String[] {
